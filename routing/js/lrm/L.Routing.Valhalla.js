        ...
        L.Routing.Valhalla = L.Class.extend({
          ...
          _routeDone : function(response, inputWaypoints, callback, context) {
            ...
            alts = [ {
              ...
              instructions : insts,// response.route_instructions ?
          ...
          buildRouteUrl : function(waypoints, options) {
            ...
            for (var i = 0; i < waypoints.length; i++) {
              ...
              if (i === 0 && transitM === "multimodal") {
                ...
                // if loaded from file
                  ...
                  loc.date_time = this.options.date_time;
              }
              locs.push(loc);
            }
            ...
            console.log(this.options.serviceUrl + 'route?json=' + params + '&api_key=' + this._accessToken);

            return this.options.serviceUrl + 'route?json=' + params + '&api_key=' + this._accessToken;
          },
