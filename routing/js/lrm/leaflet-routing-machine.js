          ...
          (
              {
                1 : [ function(require, module, exports) {
                  function corslite(url, callback, cors) {
                    ...
                    if (cors && !('withCredentials' in x)) {
                      ...
                      // Ensure callback is never called synchronously, i.e.,
                      // before
                    ...
                    // Both `onreadystatechange` and `onload` can fire.
                    // `onreadystatechange`
                    ...
                    // Call the callback with the XMLHttpRequest object as an
                    // error and prevent
                    // it from ever being called again by reassigning it to
                    // `noop`
                    ...
                    // GET is the only supported HTTP Verb by XDomainRequest and
                    // is the
                ...
                2 : [ function(require, module, exports) {
                  ...
                  // document](https://developers.google.com/maps/documentation/utilities/polylinealgorithm)
                  //
                  // Some parts from [this
                  // implementation](http://facstaff.unca.edu/mcmcclur/GoogleMaps/EncodePolyline/PolylineEncoder.js)
                  ...
                  (function() {
                    ...
                    L.Routing.Autocomplete = L.Class.extend({
                      ...
                      initialize : function(elem, callback, context, options) {
                        ...
                        // TODO: looks a bit like a kludge to register same for
                        // input and keypress -
                        // browsers supporting both will get duplicate events;
                        // just registering
                    ...
                    (function() {
                      ...
                      L.Routing.Control = L.Routing.Itinerary.extend({
                        ...
                        _routeSelected : function(e) {
                          var route = e.route, fitMode = this.options.fitSelectedRoutes, fitBounds = (fitMode === 'smart' && !this._waypointsVisible()) || (fitMode !== 'smart' && fitMode);
                        ...
                        _updateLine : function(route) {
                          ...
                          this._line = this.options.routeLine(route, L.extend({
                      ...
                      L.Routing.Formatter = L.Class.extend({
                        ...
                        formatInstruction : function(instr, i) {
                          if (instr.text === undefined) {
                            return L.Util.template(this._getInstructionTemplate(instr, i), L.extend({
                        ...
                        _getInstructionTemplate : function(instr, i) {
                          var type = instr.type === 'Straight' ? (i === 0 ? 'Head' : 'Continue') : instr.type, strings = L.Routing.Localization[this.options.language].instructions[type];
                ...
                6 : [
                    function(require, module, exports) {
                        ...
                        (function() {
                          ...
                          L.Routing.Itinerary = L.Control
                              .extend({
                                ...
                                onAdd : function(map) {
                                  var collapsible = this.options.collapsible, collapseBtn;

                                  collapsible = collapsible || (collapsible === undefined && map.getSize().x <= 640);

                                  this._container = L.DomUtil.create('div', 'leaflet-routing-container leaflet-bar ' + (!this.options.show ? 'leaflet-routing-container-hide ' : '')
                                      + (collapsible ? 'leaflet-routing-collapsible ' : '') + this.options.containerClassName);
                                ...
                                _createAlternative : function(alt, i) {
                                  var altDiv = L.DomUtil.create('div', 'leaflet-routing-alt ' + this.options.alternativeClassName
                                      + (i > 0 ? ' leaflet-routing-alt-minimized ' + this.options.minimizedClassName : '')), template = this.options.summaryTemplate, data = L.extend({
                                    name : alt.name,
                                ...
                                _createItineraryContainer : function(r) {
                                  var container = this._itineraryBuilder.createContainer(), steps = this._itineraryBuilder.createStepsContainer(), i, instr, step, distance, text, verbal_alert, verbal_pre, verbal_post, icon;
                                  ...
                                  if (L.DomUtil.hasClass(altElem, 'leaflet-routing-alt-minimized')) {
                                    for (j = 0; j < this._altElements.length; j++) {
                                      ...
                                      if (isCurrentSelection) {
                                        // TODO: don't fire if the currently
                                        // active is clicked
                                        this.fire('routeselected', {
                                          route : this._routes[j]
                                        });
                                      } else {
                                        n.scrollTop = 0;
                                      }
                      ...
                      "./L.Routing.Formatter" : 5,
                      "./L.Routing.ItineraryBuilder" : 7
                    } ],
                    ...
                    (function() {
                      ...
                      L.Routing.ItineraryBuilder = L.Class.extend({
                        ...
                        createStep : function(text, verbal_alert, verbal_pre, verbal_post, distance, icon, steps) {
                          var row = L.DomUtil.create('tr', '', steps), span, td, ul;
                    ...
                    function(require, module, exports) {
                      (function(global) {
                        (function() {
                          ...
                          var L = (typeof window !== "undefined" ? window.L : typeof global !== "undefined" ? global.L : null), corslite = require('corslite'), polyline = require('polyline');
                          ...
                          L.Routing.OSRM = L.Class.extend({
                            ...
                            _routeDone : function(response, inputWaypoints, callback, context) {
                              var coordinates, alts, actualWaypoints, i;
                              ...
                              if (response.alternative_geometries) {
                                for (i = 0; i < response.alternative_geometries.length; i++) {
                                  ...
                                  alts.push({
                                    ...
                                    response.alternative_indices : response.alternative_indices[i], coordinates)
                                  });
                                }
                              }
                            ...
                            _toWaypoints : function(inputWaypoints, vias) {
                              ...
                              for (i = 0; i < vias.length; i++) {
                                wps.push(L.Routing.waypoint(L.latLng(vias[i]), inputWaypoints[i].name, inputWaypoints[i].options));
                              }
                            ...
                            buildRouteUrl : function(waypoints, options) {
                              var locs = [], wp, computeInstructions, computeAlternative, locationKey, hint;
                              ...
                              return this.options.serviceUrl + '?' + 'instructions=' + computeInstructions + '&' + 'alt=' + computeAlternative + '&' + (options.z ? 'z=' + options.z + '&' : '')
                                  + locs.join('&') + (this._hints.checksum !== undefined ? '&checksum=' + this._hints.checksum : '') + (options.fileformat ? '&output=' + options.fileformat : '')
                            ...
                            _clampIndices : function(indices, coords) {
                              var maxCoordIndex = coords.length - 1, i;
                          ...
                          L.Routing.Plan = L.Class.extend({
                            ...
                            options : {
                              ...
                              createGeocoder : function() {
                                var container = L.DomUtil.create('div', 'leaflet-routing-geocoder'), input = L.DomUtil.create('input', '', container), remove = L.DomUtil.create('span',
                              ...
                              waypointNameFallback : function(latLng) {
                                var ns = latLng.lat < 0 ? 'S' : 'N', ew = latLng.lng < 0 ? 'W' : 'E', lat = (Math.round(Math.abs(latLng.lat) * 10000) / 10000).toString(), lng = (Math.round(Math
                                    .abs(latLng.lng) * 10000) / 10000).toString();
                            ...
                            _createGeocoder : function(i) {
                              var nWps = this._waypoints.length, g = this.options.createGeocoder(i, nWps), closeButton = g.closeButton, geocoderInput = g.input, wp = this._waypoints[i];
                            ...
                            _updateWaypointName : function(i, geocoderElem, force) {
                              var wp = this._waypoints[i], wpCoords;
                            ...
                            _dragNewWaypoint : function(newWpIndex, initialLatLng) {
                              var wp = new L.Routing.Waypoint(initialLatLng), prevWp = this._waypoints[newWpIndex - 1], nextWp = this._waypoints[newWpIndex], marker = this.options.createMarker(
                                  newWpIndex, wp, this._waypoints.length + 1), lines = [], mouseMove = L.bind(function(e) {
                                var i;
                                if (marker) {
