...
app.controller(
  ...
  function ($scope, $rootScope, $sce, $http) {
    var road = L.tileLayer("https://b.tile.openstreetmap.org/{z}/{x}/{y}.png", {
        attribution:
          '&copy; <a href="https://openstreetmap.org">OpenStreetMap</a> contributers',
      }),
      cycle = L.tileLayer(
        "http://b.tile.thunderforest.com/cycle/{z}/{x}/{y}.png?apikey=f8f13e0070864ac3ad996f7bf7beb9af",
        {
          attribution:
            'Maps &copy; <a href="http://www.thunderforest.com">Thunderforest, </a>;Data &copy; <a href="http://openstreetmap.org/copyright">OpenStreetMap contributors</a>',
        },
      ),
      elevation = L.tileLayer(
        "http://b.tile.thunderforest.com/outdoors/{z}/{x}/{y}.png?apikey=f8f13e0070864ac3ad996f7bf7beb9af",
        {
          attribution:
            'Maps &copy; <a href="http://www.thunderforest.com">Thunderforest, </a>;Data &copy; <a href="http://openstreetmap.org/copyright">OpenStreetMap contributors</a>',
        },
    ...
    var mapMatchGeoJSON = function (traceGeoJSON) {
      var markers = {
        type: "MultiPoint",
        coordinates:
          traceGeoJSON.coordinates ||
          (traceGeoJSON.geometry && traceGeoJSON.geometry.coordinates),
      };
    ...
    var update = function (show, coords, costing) {
      ...
      document.getElementById("permalink").innerHTML =
        "<a href='http://valhalla.github.io/demos/map_matching/index.html" +
        window.location.hash +
        "' target='_top'>Map Matching Permalink</a>";
    };
    ...
    $rootScope.$on("map.dropDestMarker", function (ev, geo, locCount) {
      ...
      marker.on("dragend", function (event) {
        ...
        $scope.endPoints.splice(latLngIndex - 1, 1, {
          index: latLngIndex,
          lat: position.lat,
          lon: position.lng,
          latlon: latlon,
